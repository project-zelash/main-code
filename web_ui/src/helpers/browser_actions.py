...
This script demonstrates how to perform browser actions using the controller API.
It will open a browser window, go to Google, and search for Andhra restaurants in Bangalore.
"""
...
from browser_use.controller.views import GoToUrlAction, InputTextAction, SendKeysAction, ClickElementAction
from browser_use.agent.views import ActionResult
from browser_use.browser.views import BrowserState


async def perform_browser_search():
    """
    ...
    print("\033[94mStarting Browser Actions Example (WebUI-integrated)\033[0m")
    print("\033[94mLaunching browser for Andhra restaurant search...\033[0m")
    ...
    # Start agent via run_agent_task (same as UI)
    ...
    # Stop agent (simulate stop button)
    ...
    # Clear logs (simulate clear button)
...
def main():
    """Run the browser actions example using the WebUI-integrated agent lifecycle"""
    try:
        print("\033[94mBrowser actions example starting...\033[0m")
        print("\033[93mThis will open a real browser window to perform a Google search using the WebUI agent logic.\033[0m")
        asyncio.run(perform_browser_search())
        print("\033[92mExample completed successfully!\033[0m")
    except KeyboardInterrupt:
        print("\n\033[93mExample interrupted by user\033[0m")
        sys.exit(130)
    except Exception as e:
